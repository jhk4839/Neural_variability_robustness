...
methods
    function obj = ElectricalSeries(varargin)
        ...
        varargin = [{'channel_conversion_axis' types.util.correctType(1, 'int32') 'comments' 'no comments' 'data_conversion' types.util.correctType(1, 'single') 'data_resolution' types.util.correctType(-1, 'single') 'data_unit' 'volts' 'description' 'no description'} varargin];
