...
%
% Required Properties:
%  excitation_lambda, imaging_rate, indicator, location, opticalchannel
...
properties
    ...
    imaging_rate; % REQUIRED (single) Rate that images are acquired, in Hz.
...
methods
    function obj = ImagingPlane(varargin)
        ...
        %
        %  - imaging_rate (single) - Rate that images are acquired, in Hz.
        %
