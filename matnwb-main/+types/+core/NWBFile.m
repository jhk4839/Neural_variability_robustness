...
properties(SetAccess = protected)
    nwb_version = "2.2.2"; %  (char) File version string. Use semantic versioning, e.g. 1.2.1. This will be the name of the format with trailing major, minor and patch numbers.
end
% REQUIRED PROPERTIES
properties
...
properties
    ...
    general_intracellular_ephys_filtering; %  (char) Description of filtering used. Includes filtering type and parameters, frequency fall-off, etc. If this changes between TimeSeries, filter description should be stored as a text attribute for each TimeSeries.
    general_intracellular_ephys_sweep_table; %  (SweepTable) The table which groups different PatchClampSeries together.
...
methods
    function obj = NWBFile(varargin)
        ...
        varargin = [{'nwb_version' '2.2.2'} varargin];
